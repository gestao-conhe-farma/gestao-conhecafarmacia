...
/**
 * Datas de conclusão para o calendário do dashboard: atividades/eventos/
 * entrevistas e subtarefas com prazo definido. RLS garante a visibilidade.
 * Devolve arrays crus — o dashboard filtra e molda.
 */
export async function listarDatasFuturas() {
  ...
  return { atividades: ativas.data ?? [], subtarefas: subtarefas.data ?? [] }
}
